...
const Footer = () => {
    return (
        <div className='bg-white dark:bg-gray-900'>
            <footer className="mx-2 lg:mx-20">
                <div className="container mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            <img src={logo} className="h-8 mr-3" alt="Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Master Chef</span>
                        </Link>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://web.programming-hero.com/" className="hover:underline">Programming Hero™</a>. All Rights Reserved.
                    </span>
